...
class TestBinModel(unittest.TestCase):
    ...
    def test_set2_tolerance_0(self):
        ...
        self.assertEqual(result['installed_bins'][0][1], 1.0)
        self.assertEqual(result['installed_bins'][2][4], 1.0)
        self.assertEqual(result['installed_bins'][3][2], 1.0)
        self.assertEqual(result['installed_bins'][4][0], 1.0)
        self.assertEqual(result['installed_bins'][4][3], 1.0)
        self.assertEqual(result['designated_locations'][0][0], 1.0)
        self.assertEqual(result['designated_locations'][2][2], 1.0)
        self.assertEqual(result['designated_locations'][3][3], 1.0)
    ...
    def test_set2_tolerance_10(self):
        ...
        self.assertEqual(result['installed_bins'][0][3], 1.0)
        self.assertEqual(result['installed_bins'][2][1], 1.0)
        self.assertEqual(result['installed_bins'][2][2], 1.0)
        self.assertEqual(result['installed_bins'][3][0], 1.0)
        self.assertEqual(result['designated_locations'][0][0], 1.0)
    ...
    def test_set2_tolerance_60(self):
        ...
        self.assertEqual(result['installed_bins'][0][4], 1.0)
        self.assertEqual(result['installed_bins'][2][2], 1.0)
        self.assertEqual(result['installed_bins'][2][3], 1.0)
        self.assertEqual(result['designated_locations'][0][0], 1.0)
    ...
    def test_set2_tolerance_210(self):
        ...
        self.assertEqual(result['installed_bins'][4][0], 1.0)
        self.assertEqual(result['installed_bins'][4][2], 1.0)
